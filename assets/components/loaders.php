...
<head>
  ...
  <title>Loaders - BoxCoding</title>

  <meta name="author" content="Avabucks">
  <meta name="keywords" content="Boxcoding, Avabucks, Loader">
  <meta name="description" content="Loader Components HTML, CSS & JavaScript.">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
  ...
  <div class="section">
    <div class="heading-title" data-aos="fade-in" data-aos-anchor-placement="bottom-bottom">
      ...
      <h2 class="h2">Loader Components HTML, CSS & JavaScript</h2>
