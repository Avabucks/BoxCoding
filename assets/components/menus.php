...
<head>
  ...
  <title>Menus - BoxCoding</title>

  <meta name="author" content="Avabucks">
  <meta name="keywords" content="Boxcoding, Avabucks, Menu">
  <meta name="description" content="Menu Components HTML, CSS & JavaScript.">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
  ...
  <div class="section">
    <div class="heading-title" data-aos="fade-in" data-aos-anchor-placement="bottom-bottom">
      ...
      <h2 class="h2">Menu Components HTML, CSS & JavaScript</h2>
