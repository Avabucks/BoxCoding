...
<head>
  ...
  <title>Banners - BoxCoding</title>

  <meta name="author" content="Avabucks">
  <meta name="keywords" content="Boxcoding, Avabucks, Banner">
  <meta name="description" content="Banner Components HTML, CSS & JavaScript.">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
  ...
  <div class="section">
    <div class="heading-title" data-aos="fade-in" data-aos-anchor-placement="bottom-bottom">
      ...
      <h2 class="h2">Banner Components HTML, CSS & JavaScript</h2>
